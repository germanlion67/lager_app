...
class Artikel {
  ...
  factory Artikel.fromMap(Map<String, dynamic> map) {
    return Artikel(
      ...
      erstelltAm: DateTime.parse(map['erstelltAm']),
      aktualisiertAm: DateTime.parse(map['aktualisiertAm']),
  ...
  Artikel copyWith({
    ...
    return Artikel(
      ...
      remoteBildPfad: remoteBildPfad ?? remoteBildPfad,
    );
  }
